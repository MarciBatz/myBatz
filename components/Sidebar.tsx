...
const adminNavItems = [
  ...
  // Under construction — moves to navItems once PRIVATE_TASKS_ADMIN_ONLY is off.
  {
    href: '/private-tasks',
    label: 'Privát feladataim',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full" style={{ background: '#1a1a2e' }}>
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
        <img src="/logo.jpg" alt="myBatz" className="w-9 h-9 rounded-xl flex-shrink-0 object-cover" />
        <span className="text-white font-bold text-lg">myBatz</span>
      </div>
