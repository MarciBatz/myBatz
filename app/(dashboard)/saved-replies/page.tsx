  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Sablon válaszok</h1>
          <p className="text-gray-500 text-sm mt-0.5">Újrafelhasználható válaszsablonok</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm py-16 text-center">
          <p className="text-gray-400 mb-2">Még nincs sablon válasz</p>
          <button onClick={startCreate} className="text-sm font-medium" style={{ color: '#6C5CE7' }}>Hozd létre az elsőt</button>
        </div>
      ) : (
            ...
            <div key={r.id} className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-300 mt-2">by {r.createdBy.name || r.createdBy.email}</p>
                </div>
